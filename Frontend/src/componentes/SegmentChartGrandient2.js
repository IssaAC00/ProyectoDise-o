...
export default function SegmentChartGrandient2() {
  ...
  useEffect(function () {
    ...
    setChartData({
      datasets: [
        {
          label: "Grafico Inspecciones Personales",
          data: scores,
          tension: 0.3,
          ...
          segment: {
            borderColor: function (context) {
              if (context.type === "segment") {
                return context.p1DataIndex % 2 === 0 ? "darkgray" : "chocolate"; // linea de arriba
              }
            },
            backgroundColor: function (context) {
              if (context.type === "segment") {
                return createGradientColor(
                  context.p1DataIndex % 2 === 0 ? "darkgray" : "chocolate" // utiliza los colores definidos en LineChart // relleno
                );
              }
            },
          },
